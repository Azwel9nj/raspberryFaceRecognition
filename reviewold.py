...
#contact
def contact():
    mess._show(title="Contact Me",message="If you find anything weird or you need any help contact me on 'azwelsimwinga@gmail.com'")

#how to use
def instructions():
    mess._show(title="Intructions",message="First 'Take Images' then 'Save Profile' to register users. In order to take attendance click on take attendance")

#about
def about():
    mess._show(title="About",message="This Access Control is designed by Azwel Simwinga ")
